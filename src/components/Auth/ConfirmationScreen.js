...
function ConfirmationScreen({ studentProfile, session, onConfirmStart }) {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      if (session) {
        const remaining = getSecondsUntilStart(session);
    ...
    <div className="ultimate-bg">
      <div className="glass-panel hall-ticket animate-card-entry">
        ...
        <div className="candidate-grid">
          <div className="photo-section">
            <div className="photo-frame">
              <img src={studentProfile.photoUrl || "https://via.placeholder.com/150"} alt="Candidate" className="candidate-img" />
          ...
          <div className="details-section">
            ...
            <div className="detail-row-split">
              ...
              <div className="split-item">
                ...
                <div className="value-box">{studentProfile.class || studentProfile.quizClass} - {studentProfile.section || studentProfile.quizSection}</div>
              </div>
            </div>
            <div className="detail-row">
              <label>Session</label>
        ...
        <div className="confirmation-footer">
          ...
          <button onClick={handleStart} disabled={!isConfirmed || !isExamStarted} className="start-btn" style={{ opacity: (!isExamStarted || !isConfirmed) ? 0.6 : 1 }}>
