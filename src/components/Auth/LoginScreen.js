  ...
  return (
    <div className="ultimate-bg">
      <div className="glass-panel animate-card-entry">
        ...
        <form onSubmit={handleSubmit}>
          <div className={`input-container ${focusedInput === 'roll' ? 'focused' : ''}`}>
            ...
            <div className="field-wrapper">
              ...
              <input type="text" value={rollNo} placeholder="Ex: 1201" onChange={(e) => setRollNo(e.target.value)} onFocus={() => setFocusedInput('roll')} onBlur={() => setFocusedInput(null)} disabled={loading} />
            </div>
          </div>
          ...
          <div className={`input-container ${focusedInput === 'pass' ? 'focused' : ''}`}>
            ...
            <div className="field-wrapper">
              ...
              <input type="password" value={password} placeholder="Enter Password" onChange={(e) => setPassword(e.target.value)} onFocus={() => setFocusedInput('pass')} onBlur={() => setFocusedInput(null)} disabled={loading} />
            </div>
          </div>
        ...
        <div className="panel-footer"><p>Official Contest Portal • Secure Mode</p></div>
      </div>
    </div>
  );
}
